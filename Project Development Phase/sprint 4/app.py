...
API_KEY = "L19z-jj63CSihj3CZgBgdo-sfrfA8rPacTnurkNqZmbp"
...
def predict():
    if request.method == 'POST':
        ...
        response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/3015394b-7039-48e5-b12c-dfec574874d7/predictions?version=2022-11-19', json=payload_scoring,
